...
class CreateUserView(CreateView,AuthorizationUserMixin): # README: CreateUserView 👈
    model = User
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('authorization_user:user-profile', kwargs={'pk': self.object.pk})



class LoginUserView(AuthorizationUserMixin, LoginView): # README: LoginUserView 👈
...
class UserDetailView(AuthorizationUserMixin, DetailView): # README: UserDetailView 👈
    model = User
...
class ChangeUserPasswordView(AuthorizationUserMixin, PasswordChangeView): # README: ChangeUserPasswordView 👈
...
class UserLogoutView(LogoutView, AuthorizationUserMixin):  # README: UserLogoutView
